...
class Calculadora extends JFrame implements ActionListener{
	...
	JButton residuo, raiz,potencia,fraccion,ce,c,borrar,division,multiplicacion,suma,masMenos,cero,punto,igual;
	JButton uno,dos,tres,cuatro,cinco,seis,resta,siete,ocho,nueve;
	String botonPulsado="";
	
	public Calculadora() {
		setTitle("Calculadora Chida xD");
		...
		btnmr.setBounds(70, 120, 60, 30);
		btnmr.setToolTipText("Recuperar de memoria");
		btnmr.setContentAreaFilled(false);
		btnmr.setBorderPainted(false);
		panel.add(btnmr);
		
		JButton btnmm=new JButton ("M+");
		btnmm.setBounds(130, 120, 60, 30);
		btnmm.setToolTipText("Sumar a memoria");
		btnmm.setContentAreaFilled(false);
		btnmm.setBorderPainted(false);
		panel.add(btnmm);
		
		JButton btnmmm=new JButton ("M-");
		btnmmm.setBounds(190, 120, 60, 30);
		btnmmm.setToolTipText("Restar de memoria");
		btnmmm.setContentAreaFilled(false);
		btnmmm.setBorderPainted(false);
		panel.add(btnmmm);
		
		JButton btnms=new JButton ("MS");
		btnms.setBounds(250, 120, 60, 30);
		btnms.setToolTipText("Almacenar en memoria");
		btnms.setContentAreaFilled(false);
		btnms.setBorderPainted(false);
		panel.add(btnms);
		
		JButton btnmf=new JButton ("M^");
		btnmf.setBounds(310, 120, 60, 30);
		btnmf.setToolTipText("Memoria");
		btnmf.setContentAreaFilled(false);
		btnmf.setBorderPainted(false);
		panel.add(btnmf);
		...
		//---------------------------------
		JLabel lblProcentaje= new JLabel("  %");
		lblProcentaje.setFont(new Font("Arial",Font.BOLD,24));
		residuo=new JButton();
		residuo.setBounds(10, 150, 90,60);
		residuo.setContentAreaFilled(false);
		residuo.setBorderPainted(false);
		residuo.add(lblProcentaje);
		residuo.addActionListener(this);
		panel.add(residuo);
		
		JLabel lblRaiz = new JLabel("  √");
		lblRaiz.setFont(new Font("Arial",Font.BOLD,24));
		raiz=new JButton();
		...
		JLabel letraC= new JLabel("  C");
		letraC.setFont(new Font("Arial",Font.BOLD,20));
		c=new JButton();
		...
		JLabel flechaBorrar= new JLabel(" <<x");
		flechaBorrar.setFont(new Font("Arial",Font.BOLD,20));
		borrar=new JButton();
		borrar.setBounds(190, 210, 90, 60);
		borrar.setBackground(Color.LIGHT_GRAY);
		borrar.setBorderPainted(false);
		borrar.add(flechaBorrar);
